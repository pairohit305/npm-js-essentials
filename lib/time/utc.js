...
exports.toUTC2HourLeft = exports.toUTC2Hour = exports.UTC2daytoUTCString = exports.toUTC2day = void 0;
...
function UTC2daytoUTCString(UTC2day) {
    return new Date(Date.UTC(Number(UTC2day.slice(0, 4)), Number(UTC2day.slice(4, 6)), Number(UTC2day.slice(-2)))).toUTCString();
}
